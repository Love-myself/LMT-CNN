...
def compute_classification(test_loader):
    ...
    model.load_state_dict(torch.load("record3/LMTmodel.pth"))
    model.eval()
    ...
    result_name=open("result/LMT85_"+str(seta)+".txt",'a')
...
def train_textcnn_model(model,train_loader,val_loader,num_epoch,lr,lamda):
    ...
    model_name=r'record3/LMTmodel.pth'
...
if __name__ == "__main__":
    for k in range(8,9):
        ...
        val_y=torch.load("save3/val_label"+str(k)+".pth")
